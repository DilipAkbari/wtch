...
public class LoginTest {
    ...
    public void verifyUserShouldNavigateToLoginPage() {
        ...
        By driver = null;
        WebElement loginLink = driver.findElement((SearchContext) By.linkText("Log in"));
        loginLink.click();
        // Finding the Welcome text element
        WebElement welcomeText = driver.findElement((SearchContext) By.xpath("//h1[contains(text(), 'Welcome, Please Sign In!')]"));
    ...
    public void verifyErrorMessageWhenWrongUserNameIsEntered() throws InterruptedException {
        ...
        WebElement passwordField = driver.findElement((SearchContext) By.name("Password"));
        // Send password to passwordField element
        passwordField.sendKeys("Abc123");
        //Finding the login button element
        WebElement loginBtn = driver.findElement((SearchContext) By.xpath("//input[@value='Log in']"));
        // Clicking on login button element
        loginBtn.click();
        //Finding element of error message
        WebElement errorMsg = driver.findElement((SearchContext) By.xpath("//div[@class='message-error validation-summary-errors']"));
